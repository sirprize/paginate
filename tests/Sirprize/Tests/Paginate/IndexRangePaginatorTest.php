...
class IndexRangePaginatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testNoItems()
    {
        ...
        $paginator = new IndexRangePaginator($offset, $last);
        $paginator
            ->setBaseUrl('/my-url')
            ->setPageParam('page')
            ->addParam('aa', 'abc')
    ...
    public function testOutOfBoundsItems()
    {
        $numItems = 10;
        $offset = 10;
        $last = 19;
    ...
    public function testLessItemsThanItemsPerPage()
    {
        $numItems = 2;
        $offset = 0;
        $last = 9;
    ...
    public function test15ItemsAndOnPage2()
    {
        $numItems = 15;
        $offset = 10;
        $last = 19;
    ...
    public function test123ItemsAndOnPage5()
    {
        $numItems = 123;
        $offset = 40;
        $last = 49;
